...
<html>
    ...
    <body>
    	<form method="post" action="candidatProcess" name="Formulaire Client" autocomplete="on" enctype="">
    		...
    		<p><label for="E-Mail"> E-Mail : </label> <input id="E-Mail" type="text" name="emailCandidat" placeholder="E-Mail..."></p>
