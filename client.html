...
<html>
    ...
    <body>
    	<form method="post" action="clientProcess.php" name="Formulaire Client" autocomplete="on" enctype="">
    		...
    		<p><label> <strong>Prenom : </strong> </label> <input id="name" type="text" name="prenomClient" placeholder="Prenom..."></p>
            ...
            <select name="pays"> 
                ...
                <option value="Afghanistan">Afghanistan </option>sauf 
    		...
    		<p><label for="emailClient"> E-Mail : </label> <input id="email" type="text" name="emailClient" placeholder="E-Mail..."></p>
